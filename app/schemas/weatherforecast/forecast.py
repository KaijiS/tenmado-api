...
class Forecast(BaseModel):
    ...
    highest_temperature_lower: float = Field(
        ..., description="最高気温下限", alias="highestTemperatureLower", example="17.5"
    )
    highest_temperature_upper: float = Field(
